...
export default function About() {
  return (
    <div className="min-h-screen bg-[#111827] font-outfit text-white">
      <Navbar />
      <main className="flex flex-col items-center justify-center flex-1 relative pt-16 pb-24 z-10 px-4">
        ...
        <div className="w-full flex justify-center">
          <div className="flex flex-row justify-center items-center gap-[15px] mb-8">
            <div className="w-[380px] h-[440px] bg-[#4a4a4a]/60 border border-[#5a5a5a]/40 rounded-[40px] font-outfit text-white p-0 text-left flex flex-col justify-center">
              <div className="w-full flex flex-col items-start px-[32px] pt-[32px] pb-[32px]">
                ...
                <h2 className="text-3xl font-outfit font-semibold mb-[14px]">Data Analytics</h2>
            ...
            <div className="w-[400px] h-[440px] bg-[#4a4a4a]/60 border border-[#5a5a5a]/40 rounded-[40px] font-outfit text-white p-0 text-left flex flex-col justify-center">
              <div className="w-full flex flex-col items-start px-[32px] pt-[32px] pb-[32px]">
                <div className="mb-[28px]">
                  <img src="/SVG/hobbies.svg" alt="Hobbies Icon" className="w-16 h-16" />
                </div>
                <h2 className="text-3xl font-outfit font-semibold mb-[14px]">Hobbies</h2>
