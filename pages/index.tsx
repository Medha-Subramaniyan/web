...
export default function Home() {
  return (
    ...
    Medha Subramaniyan
        ...
        <p className="font-jetbrains font-extrabold text-[40px] leading-[44px] text-[#BFDBFE] tracking-normal mb-2 -translate-y-[85px]">Data Analyst</p>
        {/* Bubbles Placeholders */}
        <div className="flex flex-row justify-evenly items-center gap-[32px] mb-10 -translate-y-[80px]">
          {/* LinkedIn Icon */}
          <div className="w-[64px] h-[76px] rounded-[38px] bg-[#4a4a4a]/60 border border-[#5a5a5a]/40 hover:bg-[#4a4a4a] hover:border-[#60a5fa]/60 hover:transform hover:scale-110 hover:shadow-2xl transition-all duration-300 cursor-pointer flex items-center justify-center group">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="text-white group-hover:scale-110 transition-transform duration-300" viewBox="0 0 16 16">
